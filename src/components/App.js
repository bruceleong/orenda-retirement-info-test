...
const App = () => (
  <div className="App">
    ...
    <div id="footer">
      ...
      <a style={{textDecoration: 'none', fontSize: '.75em'}} href="mailto:stevendeverehere@gmail.com,brucewleong@gmail.com?Subject=Issue with SBSF" target="_top">Report an Issue</a>
      <br />

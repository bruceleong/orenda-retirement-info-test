...
export default class About extends Component {
    ...
    render() {
        return (
          <div>
          <br />
          <img src="https://sbsfinancials.com/wp-content/uploads/2017/03/cropped-Turtle-logo-MC-Final-with-tagline1200x527bluer-1.png" style={{width: '50vw', height: 'auto'}} alt='SBSF logo'/>
